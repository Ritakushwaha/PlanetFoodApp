 ...
 * @author Rita
 */
public class ViewAllEmpsFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewEmpFrame
     */
    public ViewAllEmpsFrame() {
        initComponents();
    ...
    public void showDataInTable(){
        ...
        ArrayList<Employees> empList=EmployeesDao.getAllData();
    ...
    private void initComponents() {
        ...
        bck.setBackground(new java.awt.Color(0, 0, 51));
        bck.setFont(new java.awt.Font("Showcard Gothic", 1, 18)); // NOI18N
        ...
        jLabel11.setText("View All Employees details Frame");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(441, 441, 441)
                        .addComponent(bck, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllEmpsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllEmpsFrame().setVisible(true);
            }
        });
    }
