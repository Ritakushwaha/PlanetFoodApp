...
public class ViewEmpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbnDo.setBackground(new java.awt.Color(0, 0, 51));
        tbnDo.setFont(new java.awt.Font("Showcard Gothic", 1, 18)); // NOI18N
        ...
        jLabel11.setText("View Employee Frame");
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnBack, tbnDo});
    ...
    private void tbnDoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnDoActionPerformed
        ...
        else
        {
            ...
            {
                ViewSingleEmpFrame single=new ViewSingleEmpFrame();
                single.setVisible(true);
            }
            else
            {
                ViewAllEmpsFrame all=new ViewAllEmpsFrame();
                all.setVisible(true);
                this.dispose();
            }
            this.dispose();
